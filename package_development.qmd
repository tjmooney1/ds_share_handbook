...
One of the beautiful things of Data Science at SAMY is that you get to choose your path between research, development and a hybrid If you're reading this, you've probably decided that you want to explore development. 

For a high-level overview of our packages, refer to the [our packages](packages.qmd) document.
...
- [ ] Ensure function-level documentation is added to any new logic, including @headline, @description, @details, @parameters, return value, @examples and @export if function is to be exported, or @internal otherwise. Let roxygen2 take care of @usage. 
...
We use roxygen2 tags to document our functions. 
