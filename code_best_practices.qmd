...
::: {.column width="30%"} 
![Rstudio Outline](docs/img/outline_image.png) 
::: 
::::
...
Also see the [Tidyverse Design Guide](https://design.tidyverse.org/unifying.html) for a lot of stellar advice on building functions for Tidyverse functions.
...
By default your projects should be stored on the Google Drive, in the event of disaster (or minor inconvenience) this means your code and data artefacts should be backed up. However, it's still advisable to use a version control system like git - using branches to explore different avenues, or re-factor your code, can be a real headache saver and efficiency gain.
...
Google SWE Book [Reproducible Analysis, Jenny Bryan](https://jennhuck.github.io/workshops/repro_analysis_R_RStudio.html)
